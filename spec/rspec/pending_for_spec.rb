  ...
  describe '#pending_for' do
    ...
    context 'with engine' do
      it('calls pending when engine is a match') do
        ...
        expect(described_class.pending_for(:engine => 'ruby')).to be nil
      end
    ...
    context 'with versions' do
      context 'as nil' do
        ...
        context 'with engine' do
          it('calls pending when engine is a match') do
            allow(RubyEngine).to receive(:is?).and_return(true)
            expect(described_class).to receive(:pending)
            expect(described_class.pending_for(:engine => 'ruby', :versions => nil)).to be nil
          end
      ...
      context 'as empty array' do
        it('does not call pending when version is not a match') do
          ...
          expect(described_class).not_to receive(:pending)
          expect(described_class.pending_for(:versions => [])).to be nil
        end
        ...
        context 'with engine' do
          it('calls pending when engine is a match') do
            allow(RubyEngine).to receive(:is?).and_return(true)
            expect(described_class).to receive(:pending)
            expect(described_class.pending_for(:engine => 'ruby', :versions => [])).to be nil
          end
      ...
      context 'as string' do
        ...
        context 'version is a match' do
          it('calls pending') do
            expect(described_class).to receive(:pending)
            expect(described_class.pending_for(:versions => '2.1.5')).to be nil
          end
          ...
          context 'and engine' do
            it('is a match calls pending') do
              allow(RubyEngine).to receive(:is?).and_return(true)
              expect(described_class).to receive(:pending)
              expect(described_class.pending_for(:engine => 'ruby', :versions => '2.1.5')).to be nil
            end
        ...
        context 'version is not a match' do
          it('does not call pending when version is not a match') do
            expect(described_class).not_to receive(:pending)
            expect(described_class.pending_for(:versions => '2.2.3')).to be nil
          end
          ...
          context 'and engine' do
            it('is a match does not call pending') do
              allow(RubyEngine).to receive(:is?).and_return(true)
              expect(described_class).not_to receive(:pending)
              expect(described_class.pending_for(:engine => 'ruby', :versions => '2.2.3')).to be nil
            end
      ...
      context 'as array of strings' do
        ...
        context 'version is a match' do
          it('calls pending') do
            expect(described_class).to receive(:pending)
            expect(described_class.pending_for(:versions => %w[2.1.5 2.2.3])).to be nil
          end
          ...
          context 'and engine' do
            it('is a match calls pending') do
              allow(RubyEngine).to receive(:is?).and_return(true)
              expect(described_class).to receive(:pending)
              expect(described_class.pending_for(:engine => 'ruby', :versions => %w[2.1.5 2.2.3])).to be nil
            end
        ...
        context 'version is not a match' do
          it('does not call pending when version is not a match') do
            expect(described_class).not_to receive(:pending)
            expect(described_class.pending_for(:versions => %w[2.0.0 2.2.3])).to be nil
          end
          ...
          context 'and engine' do
            it('is a match does not call pending') do
              allow(RubyEngine).to receive(:is?).and_return(true)
              expect(described_class).not_to receive(:pending)
              expect(described_class.pending_for(:engine => 'ruby', :versions => %w[2.0.0 2.2.3])).to be nil
            end
